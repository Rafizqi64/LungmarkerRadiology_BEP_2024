...
#     FEATURE DEFINITION     #
#============================#
# Change feature lists if necessary
...
features_LBxfBHO = features_ensemble + features_BH_output
...
model_manager.add_model("LBx features + Brock and Herder output", features_LBxfBHO)
